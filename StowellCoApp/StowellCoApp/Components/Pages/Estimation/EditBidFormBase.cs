...
{
    public class EditBidFormBase : ComponentBase
    {
        [Parameter]
        ...
        [Inject]
        private ILogger<EditBidFormBase> logger { get; set; } = default!;
        ...
        public List<DivisionOption> divisions = new()
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                if (_contractorInfoDto != null)
                {
                    ...
                    selectedClientId = int.TryParse(_contractorInfoDto.Client, out var clientId) ? clientId : 0;
                ...
                {
                    selectedDepartment = null;  // Or you can set it to "" or any valid department name
                }
        ...
        protected async Task SaveEmployeeClick()
        {
            ...
            if (response != null)
            {
                _bidEmployeeRecords = await _estimationService.GetBidEmployees(BidNumber);
                selectedEmpRole = null;
                selectedEmployeeId = null;
                await Employeepopup.CloseAsync();
        ...
        public async Task SubmitBidAsync()
        {
            try
            {
                ...
                if (response!=null && response.Success)
                {
                    ...
                    //                   NavigationManager.NavigateTo("/Estimation/BidQueue");
                    ...
                    //    Detail = true ? "Project Update Submitted Successfully" : "Error while submitting project details",
                    //    // Duration = 10000,
         ...
         new AlertOptions() { OkButtonText = "Ok" }
            ...
            new AlertOptions() { OkButtonText = "Ok" }
                ...
                else
                {
                    ...
                    //    Duration = 4000
                    //});
                    await DialogService.Alert("Error while updating project details.", "Error");
       ...
       protected async Task DeleteBidAmountRow(BidAmount item)
        {
            ...
            if (confirmed == true)
            {
                ...
                if (response != null)
                {
                    _bidAmountRecords = await _estimationService.GetBidsAmountAsync(Convert.ToString(JobId.ToString()));
                }
        ...
        protected async Task DeleteBidPhaseRow(BidPhase item)
        {
            ...
            if (confirmed == true)
            {
                ...
                if (response != null)
                {
                    _bidphaseRecords = await _estimationService.GetPhases(JobId.ToString());
                }
