...
{
    public class RootBidFileManagerComponentBase : ComponentBase
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            //    if (_bidRecords != null)
            //    {
            //   rootPath = "\\\\DESKTOP-C86LJD9\\AnuShareFolder";
            // rootPath = _bidRecords.DocumentFolderPath;
            rootPath = Config["BidsDocSettings:RootSharePath"];
            //    }
            //}
        }
