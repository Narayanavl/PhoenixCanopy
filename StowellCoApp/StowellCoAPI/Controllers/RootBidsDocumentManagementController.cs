...
{
    [Route("api/RootBidsDocumentManagement")]
    [ApiController]
    public class RootBidsDocumentManagementController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public PhysicalFileProvider operation;
        public string basePath = string.Empty;

        public RootBidsDocumentManagementController(IConfiguration configuration, IWebHostEnvironment hostingEnvironment)
        {
